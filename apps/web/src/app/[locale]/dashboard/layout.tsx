  ...
  return (
    <ProtectedRoute>
      <div className="relative flex min-h-screen font-inter">
        ...
        {/* Mobile Bottom Nav */}
        <nav className="xl:hidden fixed bottom-0 left-0 right-0 h-24 glass z-40 flex items-center justify-around px-4 border-t border-border pb-safe shadow-[0_-10px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
          <div className="flex items-center gap-6 relative -top-1">
          ...
          {/* Space reserved for Chatwoot widget bubble */}
          <div className="w-14" />
        </nav>
