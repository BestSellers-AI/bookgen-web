...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'hero-radial': `radial-gradient(ellipse at 20% 60%, rgba(245,158,11,0.09) 0%, transparent 55%),
          radial-gradient(ellipse at 80% 20%, rgba(245,158,11,0.06) 0%, transparent 45%)`,
